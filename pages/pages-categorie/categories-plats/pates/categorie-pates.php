   ...
   <?php include('../../../../header-footer-php/header.php') ?>
    ...
    <div class="div-body">
        <div class="div-titre-plat">
            <h1 class="titre-plat">Nos Pates : </h1>
        </div>
        <div class="div-body-block">
            ...
            <a class="lien-plat"  href="/pages/pages-categorie/categories-plats/pates/pages-pates/pates-carbo.php">
                <div class="div-block">
                    <div class="div-plat-img">
            ...
            <a class="lien-plat"  href="/pages/pages-categorie/categories-plats/pates/pages-pates/pates-truffes.php">
                <div class="div-block">
                    <div class="div-plat-img">
                        <img src="/assets/img/img-categorie/categorie-pates/pates-truffes.png" alt="">
                    </div>
                    <div class="plat-description">
