...
<head>
    ...
    <title>The District - Nos Sandwichs</title>
</head>
<body>
   <!-- HEADER  -->
   <?php include('../../../../header-footer-php/header.php') ?>
    ...
    <div class="div-body">
        <div class="div-titre-plat">
            <h1 class="titre-plat">Nos sandwichs : </h1>
        </div>
        <div class="div-body-block">
            <a class="lien-plat" href="/pages/pages-categorie/categories-plats/sandwich/pages-sandwich/sandwich-ana.php">
                <div class="div-block">
            ...
            <a class="lien-plat" href="/pages/pages-categorie/categories-plats/sandwich/pages-sandwich/sandwich-daniel.php">
                <div class="div-block">
                    <div class="div-plat-img">
            ...
            <a class="lien-plat" href="/pages/pages-categorie/categories-plats/sandwich/pages-sandwich/sandwich-rajesh.php">
                <div class="div-block">
                    <div class="div-plat-img">
            ...
            <a class="lien-plat" href="/pages/pages-categorie/categories-plats/sandwich/pages-sandwich/sandwich-torobekov.php">
                <div class="div-block">
                    <div class="div-plat-img">
                        <img src="/assets/img/img-categorie/categorie-sandwich/sandwich-torobekov.png" alt="">
                    </div>
                    <div class="plat-description">
