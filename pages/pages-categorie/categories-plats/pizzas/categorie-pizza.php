   ...
   <?php include('../../../../header-footer-php/header.php') ?>
    ...
    <div class="div-body">
        <div class="div-titre-plat">
            <h1 class="titre-plat">Nos Pizzas : </h1>
        </div>
        <a class="lien-plat" href="/pages/pages-categorie/categories-plats/pizzas/pages-pizza/pizza-andre.php">
        ...
        <a class="lien-plat" href="/pages/pages-categorie/categories-plats/pizzas/pages-pizza/pizza-rene.php">
            <div class="div-block">
                <div class="div-plat-img">
        ...
        <a class="lien-plat" href="/pages/pages-categorie/categories-plats/pizzas/pages-pizza/pizza-kristina.php">
            <div class="div-block">
                <div class="div-plat-img">
        ...
        <a class="lien-plat" href="/pages/pages-categorie/categories-plats/pizzas/pages-pizza/pizza-savoyarde.php">
            <div class="div-block">
                <div class="div-plat-img">
                    <img src="/assets/img/img-categorie/categorie-pizza/pizza-savoyarde.png" alt="">
                </div>
                <div class="plat-description">
